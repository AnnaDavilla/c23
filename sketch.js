...
function setup(){
    ...
    plane = Matter.Bodies.rectangle(600,height,1200,20,plane_options)
    World.add(world, plane)
    //crie corpo block1 e adicione ao mundo
    block1 = Matter.Bodies.rectangle(100,400,150,20,plane_options)
    World.add(world, block1)
    //crie corpo block2 e adicione ao mundo
    block2 = Matter.Bodies.rectangle(400,400,150,20,plane_options)
